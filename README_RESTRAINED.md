...
[Email](mailto:nikolay.kukin@icloud.com) · [Telegram](https://t.me/nikolaykukin) · [GitHub](https://github.com/nikolay-kukin)
...
[chgzabor](https://github.com/nikolay-kukin/chgzabor) — fullstack-приложение с Java backend, frontend-частью и контейнеризированным локальным окружением.  
[techfluency-lesson](https://github.com/nikolay-kukin/techfluency-lesson) — учебная fullstack-платформа с backend, frontend, контейнеризированной инфраструктурой и демонстрационными материалами.

### Python и эксперименты

[car-match-agent](https://github.com/nikolay-kukin/car-match-agent) — учебный multi-agent сервис подбора автомобиля с локальным каталогом, проверками ограничений и eval-сценариями.  
[algorithms](https://github.com/nikolay-kukin/algorithms) — коллекция собственных решений алгоритмических задач и реализаций базовых структур данных.

### Embedded и учебные проекты

[atmega16-labs](https://github.com/nikolay-kukin/atmega16-labs) — учебные проекты для ATmega16 с исходниками, схемами и симуляциями в Proteus.  
[nokia3310-atmega16](https://github.com/nikolay-kukin/nokia3310-atmega16) — embedded-проект для дисплея Nokia 3310 / PCD8544 на ATmega16 с симуляцией и демонстрацией работы.
